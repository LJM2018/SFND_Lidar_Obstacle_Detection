...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    renderPointCloud(viewer, inputcloud, "input cloud", Color(0,1,0));
    ...
    std::vector<pcl::PointCloud<pcl::PointXYZ>::Ptr> cloudClusters = pointProcessor->Clustering(segmentCloud.first, 1.0, 3, 40);
...
void cityBlockSingeFrame(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
  // ----------------------------------------------------
